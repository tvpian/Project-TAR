...
class OffboardControl(Node):
    ...
    def __init__(self) -> None:
        ...
        self.publisher_thread = threading.Thread(target=self.publish_trajectory_setpoints, args=())
    ...
    def publish_trajectory_setpoints(self) -> None:
        while rclpy.ok():
            if self.vehicle_status.arming_state == 2 and self.vehicle_status.nav_state == 14:
                ...
                # Delay to control the rate of publication
