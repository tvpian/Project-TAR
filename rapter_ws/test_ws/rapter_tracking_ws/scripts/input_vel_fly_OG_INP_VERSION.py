...
class OffboardControl(Node):
    ...
    def update_trajectory(self):
        if rclpy.ok():
            ...
            dt = 0.05
            pos_x = target_velocity[0] * dt + self.vehicle_local_position.x
            pos_y = target_velocity[1] * dt + self.vehicle_local_position.y
            pos_z = target_velocity[2] * dt + self.vehicle_local_position.z

            vel_x = target_velocity[0]
            vel_y = target_velocity[1]
